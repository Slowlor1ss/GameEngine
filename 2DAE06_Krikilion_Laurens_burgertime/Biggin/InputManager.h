...
namespace biggin
{
	...
	public:
		...
		bool IsHeld(SDL_Keycode key, ControllerButton button, int idx) const;
		bool IsPressed(SDL_Keycode key, ControllerButton button, int idx) const;
		bool IsReleased(SDL_Keycode key, ControllerButton button, int idx) const;
